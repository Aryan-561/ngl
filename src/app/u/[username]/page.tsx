...
export default function SendMessage() {
  ...
  return (
    <>
      <SEOHead 
        title={`Send Anonymous Feedback to @${username} - AnonBox`}
        description={`Send professional anonymous feedback to @${username} safely and securely on AnonBox! Share your thoughts, ask questions, or provide workplace feedback without revealing your identity.`}
        ogUrl={`https://www.anonbox.tech/u/${username}`}
      />
